...
/// \file femtoDreamMixedEventTask.cxx
...
struct femtoDreamPremixingTask {
...
struct femtoDreamMixedEventTask {
...
{
  WorkflowSpec workflow{adaptAnalysisTask<femtoDreamPremixingTask>(cfgc),
                        adaptAnalysisTask<femtoDreamMixedEventTask>(cfgc)};
  return workflow;
}
